...
--Q7. Segment customer into New, Returning, and Loyal based on thier total number of
-- previous purchase, andshow the count of each segment.
...
--Q9. Are customer who are repeat buyers (more than previous purchase) also likely to subscribe?
select subscription_status,
